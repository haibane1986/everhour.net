...
namespace Everhour.Net
{
    internal partial interface IEverhourClient
    {
        ...
        Task<SetProjectBillingResponse> SetProjectBillingAsync(SetProjectBillingRequest request);
        Task<SetProjectBillingResponse> SetProjectBillingAsync(string projectId, BillingType type);
