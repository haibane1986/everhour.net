...
namespace Everhour.Net.Tests.ResourceFacts
{
    public class Timers : FactBase
    {
        ...
        public async Task StartTimerAsync_ReturnsTimer()
        {
            ...
            Assert.Equal("Everhour", res.Timer.Task.Attributes.Client);
            Assert.Equal("hight", res.Timer.Task.Attributes.Priority);
            Assert.Equal(42, res.Timer.Task.Metrics.Efforts);
            Assert.Equal(199, res.Timer.Task.Metrics.Expenses);
        ...
        public async Task ListTeamUsersTimersAsync_ReturnsTimers()
        {
            ...
            Assert.All(res.Timers, e => Assert.Equal("Everhour", e.Task.Attributes.Client));
            Assert.All(res.Timers, e => Assert.Equal("hight", e.Task.Attributes.Priority));
            Assert.All(res.Timers, e => Assert.Equal(42, e.Task.Metrics.Efforts));
            Assert.All(res.Timers, e => Assert.Equal(199, e.Task.Metrics.Expenses));
